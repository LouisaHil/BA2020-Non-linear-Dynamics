%% streamlines
alpha=0.2;
title('The streamlines of the velocity field for t=0, Okubo Weiss region and KAM Map for alpha=0.2')
...
streamline(x,y,u1,v,startx,starty,[0.008,3000])
hold on
...
startx=-x;
starty=-y;
streamline(x,y,u2,v2,startx,starty,[0.008,3000])
hold on 
...
plot(axisx(300:end,:),axisy(300:end,:),'k.','MarkerSize',0.4')
